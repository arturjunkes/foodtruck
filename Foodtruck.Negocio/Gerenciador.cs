...
namespace Foodtruck.Negocio
{
    public class Gerenciador
    {
        ...
        public Validacao AlterarBebida(Bebida bebidaAlterada)
        {
            ...
            bebidaBanco.Tamanho = bebidaBanco.Tamanho;
        ...
        public Validacao AdicionarBebida(Bebida bebidaAdicionada)
        {
            ...
            if(this.banco.Bebidas.Where(x => x.Id == bebidaAdicionada.Id).Any())
            {
            ...
            if(string.IsNullOrEmpty(Convert.ToString(bebidaAdicionada.Tamanho)))
            {
                validacao.Mensagens.Add("tamanho", "O campo tamanho não pode ser nulo ou vazio");
            }

            if (string.IsNullOrEmpty(Convert.ToString(bebidaAdicionada.Valor)))
            {
        ...
        public Validacao AdicionarLanche(Lanche lancheAdicionado)
        {
            ...
            if (this.banco.Lanches.Where(x => x.Id == lancheAdicionado.Id).Any())
            {
                validacao.Mensagens.Add("id", "Já existem uma bebida com esse código");
            }
            ...
            if (string.IsNullOrEmpty(Convert.ToString(lancheAdicionado.Valor)))
            {
                validacao.Mensagens.Add("valor", "O campo valor não pode ser nulo ou vazio");
            }
