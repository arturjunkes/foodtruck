...
{
    public partial class TelaManterBebida : Form
    {
        public Bebida BebidaSelecionada { get; set; }
        public TelaManterBebida()
        {
            InitializeComponent();
        }

        private void TelaManterBebida_Load(object sender, EventArgs e)
        {
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            bebida.Tamanho = (float)Convert.ToDouble(tbTamanho.Text);
            bebida.Valor = Convert.ToInt32(tbValor.Text);
