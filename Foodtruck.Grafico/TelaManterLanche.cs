...
{
    public partial class TelaManterLanche : Form
    {
        public Lanche LancheSelecionado { get; set; }
        public TelaManterLanche()
        {
            InitializeComponent();
        }
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            lanche.Valor = Convert.ToInt32(tbValor.Text);
        ...
        private void TelaManterLanche_Load(object sender, EventArgs e)
        {
